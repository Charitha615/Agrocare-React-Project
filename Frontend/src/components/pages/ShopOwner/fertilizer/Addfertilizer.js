...
class CreateProduct extends Component {
  ...
  onSubmit(event) {
    ...
    axios.post(`${APIURL}/product/`, ProductDetails, config).then((res) => {
      console.log("res", res);
      if (res.status === 201) {
                            ...
                            <div className="form-group row">
                              ...
                              <div className="col-sm-10">
                                <input
                                  ...
                                  type="text"
                                  placeholder="Fertilizer Name is..."
                            ...
                            <div className="form-group row">
                              ...
                              <div className="col-sm-10">
                                <input
                                  className="form-control"
                                  type="text"
                                  placeholder="A Fertilizer Price is..."
                                  id="example-text-input"
                                  name="unit_price"
                            ...
                            <div className="form-group row">
                              ...
                              <div className="col-sm-10">
                                <input
                                  className="form-control"
                                  type="text"
                                  placeholder="Fertilizer quantities are..."
                                  id="example-text-input"
                                  name="quantity"
